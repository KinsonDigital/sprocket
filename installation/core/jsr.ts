 ...
 */
export async function getJsrPkgMetaData(scope: string, pkgName: string): Promise<string[]> {
...
/**
 * Gets the latest version of a package from JSR.
 * @param scope The scope of the package.
 * @param pkgName The name of the package.
 * @returns The latest version of the package.
 */
export async function getLatestVersion(scope: string, pkgName: string): Promise<string> {
	const versions = await getJsrPkgMetaData(scope, pkgName);

	return versions.length > 0 ? versions[0] : "latest";
}
